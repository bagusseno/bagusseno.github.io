(function ($) {
  ...
  $(function () {
    ...
    if ($('#sales-statistics-overview').length) {
      ...
      var data_1_1 = [
        {y: 62, x: new Date('2022-01-01')}, 
        {y:75, x: new Date('2022-01-07')}, 
        {y:65, x: '2022-01-14'}, 
        {y:130, x: '2022-01-21'}, 
        {y:130, x: '2022-01-28'}, 
        {y:75, x: '2022-02-07'}, 
    ...
    if ($('#sales-statistics-overview-2').length) {
      var salesChartCanvas = $("#sales-statistics-overview-2").get(0).getContext("2d");
      var gradientStrokeFill_1 = salesChartCanvas.createLinearGradient(0, 0, 0, 450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      var gradientStrokeFill_2 = salesChartCanvas.createLinearGradient(0, 0, 0, 400);
    ...
    if ($('#sales-statistics-overview-3').length) {
      var salesChartCanvas = $("#sales-statistics-overview-3").get(0).getContext("2d");
      var gradientStrokeFill_1 = salesChartCanvas.createLinearGradient(0, 0, 0, 450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      var gradientStrokeFill_2 = salesChartCanvas.createLinearGradient(0, 0, 0, 400);
